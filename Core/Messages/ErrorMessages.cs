...
{
    public const string wrongMenuCommand = "Wrong menu option";
    
    public const string wrongFilePath = "File with this name do not exists";
    
    public const string wrongSortOrder = "Wrong sort order";
